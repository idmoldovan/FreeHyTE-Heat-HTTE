function varargout = CheckHeatTri(varargin)
% CHECKHEATTRI MATLAB code for CheckHeatTri.fig
%      CHECKHEATTRI, by itself, creates a new CHECKHEATTRI or raises the existing
%      singleton*.
%
%      H = CHECKHEATTRI returns the handle to a new CHECKHEATTRI or the handle to
%      the existing singleton*.
%
%      CHECKHEATTRI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CHECKHEATTRI.M with the given input arguments.
%
%      CHECKHEATTRI('Property','Value',...) creates a new CHECKHEATTRI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CheckHeatTri_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CheckHeatTri_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CheckHeatTri

% Last Modified by GUIDE v2.5 18-Jul-2017 16:06:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CheckHeatTri_OpeningFcn, ...
                   'gui_OutputFcn',  @CheckHeatTri_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CheckHeatTri is made visible.
function CheckHeatTri_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CheckHeatTri (see VARARGIN)

% Choose default command line output for CheckHeatTri
...
% UIWAIT makes CheckHeatTri wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CheckHeatTri_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(CheckHeatTri); % closing the GUI window
