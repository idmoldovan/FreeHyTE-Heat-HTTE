function MainReg
% MainReg is the main routine of FreeHyTE - Steady State Heat Conduction 
...
if(RunOption==1)
    ...
    % COMPUTEFIELDSREG returns the Loops structure with the values of the 
    % fields in a NoDiv x NoDiv grid in each element.
    ...
    % PLOTFIELDSREG plots the temperature and flux fields
