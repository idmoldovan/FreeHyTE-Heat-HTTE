function varargout = CheckHeatReg(varargin)
% CHECKHEATREG MATLAB code for CheckHeatReg.fig
%      CHECKHEATREG, by itself, creates a new CHECKHEATREG or raises the existing
%      singleton*.
%
%      H = CHECKHEATREG returns the handle to a new CHECKHEATREG or the handle to
%      the existing singleton*.
%
%      CHECKHEATREG('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CHECKHEATREG.M with the given input arguments.
%
%      CHECKHEATREG('Property','Value',...) creates a new CHECKHEATREG or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CheckHeatReg_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CheckHeatReg_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help CheckHeatReg

% Last Modified by GUIDE v2.5 03-Aug-2016 21:34:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CheckHeatReg_OpeningFcn, ...
                   'gui_OutputFcn',  @CheckHeatReg_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CheckHeatReg is made visible.
function CheckHeatReg_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CheckHeatReg (see VARARGIN)

% Choose default command line output for CheckHeatReg
...
% UIWAIT makes CheckHeatReg wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CheckHeatReg_OutputFcn(hObject, eventdata, handles) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close(CheckHeatReg); % closing the GUI window
